...
class RabbitMQConnection:
    ...
    async def connect(self):
        ...
        try:
            ...
            log_info("RabbitMQ connected", service="mail-service")

        except Exception as e:
            log_error(f"RabbitMQ connection error: {e}", service="mail-service")
            raise
    ...
    async def close(self):
        if self.connection and not self.connection.is_closed:
            ...
            log_info("RabbitMQ connection closed", service="mail-service")
