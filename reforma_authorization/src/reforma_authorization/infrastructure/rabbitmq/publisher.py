import json
from reforma_authorization.infrastructure.config.rabbitmq_config import RABBITMQ_HOST
from reforma_authorization.infrastructure.rabbitmq.connection import RabbitMQConnection
from reforma_authorization.infrastructure.config.rabbitmq_config import RABBITMQ_PORT
        ...
        try:
            ...
            log_error(
                ...
                context={
                    ...
                    "event_type": event_type,
                    "routing_key": routing,
                    "payload_size_bytes": len(json.dumps(message).encode())
